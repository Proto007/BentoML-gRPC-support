...
stub=lda_model_pb2_grpc.PredictLdaStub(channel)
...
query_string=lda_model_pb2.PredictTopicRequest(query_description=description)

# Call the predict function
response=stub.predict(query_string)
